...
export function SearchFilterBar<T = any>({
  ...
  const containerClass = dense
    ? 'flex flex-col gap-2 md:flex-row md:items-center md:gap-2 p-3'
    : 'flex flex-col gap-4 md:flex-row md:items-center md:justify-between p-4 bg-gray-50 border-b rounded-t-lg';
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:flex-1 md:gap-3">
        ...
        <div className={`relative ${inputWrapperClass}`}>
          ...
          <input
            ...
            className="w-full pl-10 pr-9 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
          />
          {searchInput && (
            <button
        ...
        {filterOptions.length > 0 && (
          <div className="relative">
            <select
              ...
              className="appearance-none pr-10 pl-3 py-2 border rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
            >
        ...
        {sortOptions.length > 0 && (
          <div className="relative">
            <button
              ...
              className="flex items-center justify-between gap-2 px-3 py-2 border rounded-lg text-sm bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all w-full md:w-auto"
            >

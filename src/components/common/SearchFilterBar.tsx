...
export function SearchFilterBar<T = any>({
  ...
  const containerClass = dense
    ? 'flex flex-col gap-2 md:flex-row md:items-center md:gap-2 p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm'
    : 'flex flex-col gap-4 md:flex-row md:items-center md:justify-between p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm';
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:flex-1 md:gap-3">
        ...
        {sortOptions.length > 0 && (
          <div className="relative">
            ...
            {showSortDropdown && (
              <div className="absolute z-50 top-full right-0 mt-1 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg">
